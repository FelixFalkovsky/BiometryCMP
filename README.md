...
- **iOS:** 11.0+ (Touch ID / Face ID via LocalAuthentication)
- **macOS** — required for building and testing iOS (simulator)
...
- Xcode (for iOS)
- CocoaPods (optional; only if using CocoaPods in the sample app)
